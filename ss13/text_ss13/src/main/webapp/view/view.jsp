...
<%--            <td scope="row">${user.getId()}</td>--%>
            ...
            <td><a class="btn btn-dark" href="/UserServletss13?actionUser=update&id=${user.getId()}"
...
<a class="btn btn-info" href="/UserServletss13?actionUser=create" role="button">Create</a>
